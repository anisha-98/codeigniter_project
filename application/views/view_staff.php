...
<tr class="table-primary">
       ...
       <td> <?php echo $row->pincode;?></td>
        ...
        <td class="table-success"><?php echo $row->section;?></td>
        ...
        <?php if($row->status=='1'){
            ?>
            <td>Approved <a href="<?php echo base_url() ?>amsctrl/reject/<?php echo $row->id;?>" class="btn btn-info">/reject</a></td>
            <?php }
            else if($row->status==2)
            {
                ?>
                <td>Rejected<a href="<?php echo base_url() ?>amsctrl/approve/<?php echo $row->id; ?>" class="btn btn-info">Approve</a></td>
                <?php
            }
            else {
                ?>
                <td><a href="<?php echo base_url()?>amsctrl/approve/<?php echo $row->id; ?>"> Approve</a><a href="<?php echo base_url() ?>amsctrl/reject/<?php echo $row->id; ?>">/reject</a></td></tr> 
                <?php }
}
