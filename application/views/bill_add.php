    ...
    <div class="container">
      <div class=" row vh-100 align-items-center">
        <div class=" col text-white text-center">
            <div class='shade3'>
        	<h1>SALARY BILL ADD</h1>
        	<form action="<?php echo base_url()?>amsctrl/bill_add_action" method="post" enctype="multipart/form-data">

				
			 Name:<input type="text"  name="name"  class="text-center p-3">

        <input type="file"  name="bill" id="bill" class="text-center p-3">
        <br>
