...
?>
    ...
    <tr class="table-primary">
        ...
        <td class="table-light"><?php echo $row->s_name;?></td>
        <td><?php echo $row->fathername;?></td>
        <td><?php echo $row->address;?></td>
       <td class="table-secondary"> <?php echo $row->gender;?></td>
        <td><?php echo $row->district;?></td>
        <td><?php echo $row->pincode;?></td>
        <td  class="table-warning"><?php echo $row->mobileno;?></td>
        <td class="table-success"><?php echo $row->education;?></td>
        ...
        <?php if($row->status=='1'){
            ?>
            <td>Approved <a href="<?php echo base_url() ?>amsctrl/rejectt/<?php echo $row->id;?>" class="btn btn-info">/reject</a></td>
            <?php }
            else if($row->status==2)
            {
                ?>
                <td>Rejected<a href="<?php echo base_url() ?>amsctrl/approvee/<?php echo $row->id; ?>" class="btn btn-info">Approve</a></td>
                <?php
            }
            else {
                ?>
                <td><a href="<?php echo base_url()?>amsctrl/approvee/<?php echo $row->id; ?>"> Approve</a><a href="<?php echo base_url() ?>amsctrl/rejectt/<?php echo $row->id; ?>">/reject</a></td></tr> 
                <?php }
}
