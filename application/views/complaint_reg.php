...
<section class="">
  <div class="container-fluid bg-dark comadd">
    <div class="container">
      <div class="row  align-items-center">
        <div class=" text-danger text-center mt-5">
        <h1 class="text-info">Complaint ADD</h1><b>
	<h1 class="text-info" >Complaint:<textarea type="text" name="not"></textarea><br><pre>

	<input style="color:white" type="submit" value="submit" class="btn btn-info px-5">
