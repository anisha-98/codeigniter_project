  ...
  <div class="container-fluid  ">
    <div class="container">
      <div class="row vh-100 ">
		...
		<p class="h3">TRAINER REGISTRATION </p>
</div>
		</div>
<div class="col-6">
	<div class="card m-1">
	<form method="post" action="<?php echo base_url()?>amsctrl/trainerAction" enctype="multipart/form-data">
...
<div class="row m-2 text-white text-center">
		...
		<div class="col-8 p-1">
		<select name="district" class="form-control1">
...
<div class="row m-2 text-white text-center">
		<div class="col-4 putclr">
			<label class="label control-label m-2">Subject</label>
		</div>
		<div class="col-8 p-1">
		<select id="subject" name="subject" class="form-control1">
...
<div class="row m-2 text-white text-center">
	...
	<input type="submit" value="Register" class="button text-white">
